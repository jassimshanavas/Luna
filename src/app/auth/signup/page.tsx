...
import { Mail, Lock, Chrome, ArrowRight, Loader2, User, Sparkles } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div style={{
                ...
                <Sparkles size={100} color="var(--primary)" style={{ transform: 'rotate(-12deg)' }} />
            </div>
            ...
            <motion.div variants={itemVariants} style={{ textAlign: 'center', marginBottom: '40px', position: 'relative' }}>
                ...
                <h1 style={{
                    ...
                    Join <span style={{ color: 'var(--primary)', fontStyle: 'italic' }}>Luna</span>
                </h1>
            ...
            <motion.div variants={itemVariants} style={{ position: 'relative', margin: '28px 0' }}>
                ...
                <div style={{ position: 'relative', display: 'flex', justifyContent: 'center', fontSize: '10px', textTransform: 'uppercase', fontWeight: 800, letterSpacing: '0.1em' }}>
                    <span style={{ padding: '0 16px', background: 'transparent', color: 'var(--text-muted)' }}>Fast Enrollment</span>
                </div>
            </motion.div>
